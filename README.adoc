...
image:https://travis-ci.org/Treydone/hhsl.svg?branch=master[https://travis-ci.org/Treydone/hhsl]
image:https://sonarcloud.io/api/project_badges/measure?project=fr.layer4.hhsl%3Ahhsl&metric=alert_status[https://sonarcloud.io/dashboard?id=fr.layer4.hhsl%3Ahhsl]
image:https://sonarcloud.io/api/project_badges/measure?project=fr.layer4.hhsl%3Ahhsl&metric=reliability_rating[https://sonarcloud.io/dashboard?id=fr.layer4.hhsl%3Ahhsl]
...
Preferred way to unlock the secured store, prompt asks the user to enter the root password
--unlock @prompt

For background process or automatic filling of the root password, you can use the following values
--unlock <some password>
Be aware that your commands will be store in the history of your shell..
--unlock file:///...
Use a file containing the root password. Ensure to protect this file with some restrictions (chown+chmod 700)
