...
image:https://sonarcloud.io/api/project_badges/measure?project=fr.layer4.hhsl%3Ahhsl&metric=coverage[link=https://sonarcloud.io/dashboard?id=fr.layer4.hhsl%3Ahhsl]
