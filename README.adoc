...
image:https://travis-ci.LocalClusterService org/Treydone/hhsl.svg?branch=master["Build Status", link="https://travis-ci.org/Treydone/hhsl"]
image:https://sonarcloud.io/api/project_badges/measure?project=fr.layer4.hhsl%3Ahhsl&metric=alert_status[]
image:https://sonarcloud.io/api/project_badges/measure?project=fr.layer4.hhsl%3Ahhsl&metric=reliability_rating[]
