...
```
hhsl add cluster local ambari PROD-HDP3.0 http://ambari:8080 --unlock XXX
> user:
> password:
```
...
```
hhsl use PROD-HDP3.0 --unlock XXX
...
HHSL can be used to just install binaries, ie without cluster configuration or environment management:
 ...
 hhsl install hadoop 2.7.7 --unlock XXX
